"""Pipeline v7: cleanup agressivo + curagem 4 frames + 2 idle frames sutis + deploy."""
from pathlib import Path
from PIL import Image
import shutil

BK = Path(r"C:\Users\Pedro\Desktop\PEDRO_DIRETOR V7 BACKUP")
...
def main():
    ...
    for d in DIRS:
        ...
        # Remove possíveis frames antigos
