...
const es: Record<TranslationKey, string> = {
  ...
  // Header Controls
  "header.simulate": "INICIAR SIMULACIÓN",
  "header.simulateStop": "DETENER SIMULACIÓN",
  ...
  "modal.minimize": "Restaurar tamaño",
  ...
  "sessions.olderSession_one": "{count} sesión anterior",
  "sessions.olderSession_other": "{count} sesiones anteriores",
  ...
  "sessions.cannotResumeExternal": "Sesión externa — no puede ser reanudada via claude",
  "sessions.focusTerminal": "Traer la ventana del terminal al frente",
  "sessions.browserOpen": "Centro de Sesiones",
  "sessions.browserTitle": "Centro de Sesiones",
  "sessions.searchPlaceholder": "Buscar sesión…",
  "sessions.filterStatus": "Estado",
  "sessions.filterPeriod": "Período",
  "sessions.filterFloor": "Piso",
  "sessions.statusAll": "Todas",
  "sessions.statusActive": "Activas",
  "sessions.statusCompleted": "Completadas",
  "sessions.periodAll": "Cualquier momento",
  "sessions.period24h": "Últimas 24h",
  "sessions.period7d": "Últimos 7 días",
  "sessions.floorAll": "Todos los pisos",
  "sessions.noMatches": "Ninguna sesión coincide con los filtros",
  "sessions.countShown": "Mostrando {shown} de {total}",
  ...
  "conversation.loadOlder": "↑ Cargar {count} mensajes anteriores",
  "conversation.loadOlder_one": "↑ Cargar {count} mensaje anterior",
  "conversation.loadOlder_other": "↑ Cargar {count} mensajes anteriores",
  ...
  "attention.popup.takeControl": "Controlar (Flechas)",
  "attention.popup.close": "Cerrar",
  "attention.control.banner": "Controlando {name} — Flechas para mover, Esc para soltar",
  "attention.control.release": "Soltar",
