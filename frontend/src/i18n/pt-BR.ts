...
const ptBR: Record<TranslationKey, string> = {
  ...
  // Header Controls
  "header.simulate": "LIGAR SIMULAÇÃO",
  "header.simulateStop": "DESLIGAR SIMULAÇÃO",
  ...
  "modal.minimize": "Restaurar tamanho",
  ...
  "sessions.olderSession_one": "{count} sessão anterior",
  "sessions.olderSession_other": "{count} sessões anteriores",
  ...
  "sessions.cannotResumeExternal": "Sessão externa — não pode ser retomada via claude",
  "sessions.focusTerminal": "Trazer terminal pra frente",
  "sessions.browserOpen": "Central de Sessões",
  "sessions.browserTitle": "Central de Sessões",
  "sessions.searchPlaceholder": "Buscar sessão…",
  "sessions.filterStatus": "Status",
  "sessions.filterPeriod": "Período",
  "sessions.filterFloor": "Andar",
  "sessions.statusAll": "Todas",
  "sessions.statusActive": "Ativas",
  "sessions.statusCompleted": "Concluídas",
  "sessions.periodAll": "Sempre",
  "sessions.period24h": "Últimas 24h",
  "sessions.period7d": "Últimos 7 dias",
  "sessions.floorAll": "Todos os andares",
  "sessions.noMatches": "Nenhuma sessão corresponde aos filtros",
  ...
  "conversation.loadOlder": "↑ Carregar {count} mensagens anteriores",
  "conversation.loadOlder_one": "↑ Carregar {count} mensagem anterior",
  "conversation.loadOlder_other": "↑ Carregar {count} mensagens anteriores",
  ...
  "attention.popup.takeControl": "Controlar (Setas)",
  "attention.popup.close": "Fechar",
  "attention.control.banner": "Controlando {name} — Setas pra mover, Esc pra soltar",
