const en = {
  ...
  // Header Controls
  "header.simulate": "START SIMULATION",
  "header.simulateStop": "STOP SIMULATION",
  "header.reset": "RESET",
  ...
  "sessions.olderSession_one": "{count} older session",
  "sessions.olderSession_other": "{count} older sessions",
  ...
  "sessions.cannotResumeExternal": "External session — cannot be resumed via claude",
  "sessions.focusTerminal": "Bring terminal window to front",
  "sessions.browserOpen": "Sessions Hub",
  "sessions.browserTitle": "Sessions Hub",
  "sessions.searchPlaceholder": "Search session…",
  "sessions.filterStatus": "Status",
  "sessions.filterPeriod": "Period",
  "sessions.filterFloor": "Floor",
  "sessions.statusAll": "All",
  "sessions.statusActive": "Active",
  "sessions.statusCompleted": "Completed",
  "sessions.periodAll": "Anytime",
  "sessions.period24h": "Last 24h",
  "sessions.period7d": "Last 7 days",
  "sessions.floorAll": "All floors",
  "sessions.noMatches": "No sessions match your filters",
  "sessions.countShown": "Showing {shown} of {total}",
  ...
  "conversation.loadOlder": "↑ Load {count} earlier messages",
  "conversation.loadOlder_one": "↑ Load {count} earlier message",
  "conversation.loadOlder_other": "↑ Load {count} earlier messages",
  ...
  "attention.popup.takeControl": "Take Control (Arrows)",
  "attention.popup.close": "Close",
  "attention.control.banner": "Controlling {name} — Arrow keys to move, Esc to release",
  "attention.control.release": "Release",
